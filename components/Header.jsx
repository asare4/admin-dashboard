...
const Header = () => {
  return <header className='bg-[#1e1e1e] shadow-lg border-b border-[#1f1f1f] mx-4 sm:mx-6 lg:mx-8 mt-4 mb-2 rounded-lg'>
    <div className='max-w-7xl mx-auto py-4 px-4 sm:px-6 flex items-center justify-between'>
      ...
      <div className='flex items-center space-x-3 sm:space-x-6'>
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <span className="hidden sm:block text-gray-100 font-medium ">Nana Asare</span>
        </div>
      </div>
    </div>
  </header>;
